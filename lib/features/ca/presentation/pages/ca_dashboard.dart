          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) => ListTile(
              leading: CircleAvatar(
                ...
                child: Icon(
                  index == 0 ? Icons.description : 
                  index == 1 ? Icons.check_circle : Icons.person_add,
                  color: AppTheme.primaryColor,
                ),
              ),
              title: Text(
                index == 0 ? 'Certificate issued to John Doe' :
                index == 1 ? 'Document approved: Academic Record' :
                'New user registration reviewed',
        ...
        Card(
          child: ListView.separated(
            ...
            itemBuilder: (context, index) => ListTile(
              ...
              title: Text(
                index == 0 ? 'Academic Transcript - Jane Smith' :
