...
class CACertificateCreationPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CACertificateCreationPage> createState() => _CACertificateCreationPageState();
}

class _CACertificateCreationPageState extends ConsumerState<CACertificateCreationPage> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: AppTheme.spacingM),
            if (_selectedType == CertificateType.academic || _selectedType == CertificateType.completion) ...[
              TextFormField(
            ...
            if (_selectedType == CertificateType.achievement || _selectedType == CertificateType.recognition) ...[
              const SizedBox(height: AppTheme.spacingM),
              TextFormField(
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              subtitle: Text(_completedAt?.toString().split(' ')[0] ?? 'Not set'),
              trailing: const Icon(Icons.edit),
