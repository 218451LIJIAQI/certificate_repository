...
class CAService {
  ...
  Future<CAStats> getCAStats() async {
    try {
      ...
      final totalDocsQuery = await _firestore
          .collection('documents')
          .get();
      ...
      LoggerService.error('Failed to get CA stats', error: error, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<String> createCertificate({
    ...
    try {
      ...
      LoggerService.error('Failed to create certificate', error: error, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<void> saveCertificateDraft({
    ...
    try {
      ...
      LoggerService.error('Failed to save certificate draft', error: error, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<List<DocumentModel>> getPendingDocuments() async {
    try {
      ...
      LoggerService.error('Failed to get pending documents', error: error, stackTrace: stackTrace);
      return [];
    }
  }
  ...
  Future<void> approveDocument(String documentId, String comments) async {
    try {
      ...
      LoggerService.error('Failed to approve document', error: error, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<void> rejectDocument(String documentId, String reason) async {
    try {
      ...
      LoggerService.error('Failed to reject document', error: error, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<CASettingsModel> getCASettings() async {
    try {
      ...
      LoggerService.error('Failed to get CA settings', error: error, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<void> updateCASettings(CASettingsModel settings) async {
    try {
      ...
      LoggerService.error('Failed to update CA settings', error: error, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<void> revokeCertificate(String certificateId, String reason) async {
    try {
      ...
      LoggerService.error('Failed to revoke certificate', error: error, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<List<CertificateTemplate>> getCertificateTemplates() async {
    try {
      ...
      LoggerService.error('Failed to get certificate templates', error: error, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  Future<void> uploadCertificateTemplate({
    ...
    try {
      ...
      LoggerService.info('Certificate template uploaded successfully: $templateId');
    } catch (error, stackTrace) {
      LoggerService.error('Failed to upload certificate template', error: error, stackTrace: stackTrace);
      rethrow;
    }
  }
  ...
  String _generateCertificateHash(String certificateId, String verificationCode) {
    final content = '$certificateId-$verificationCode-${DateTime.now().millisecondsSinceEpoch}';
  ...
  Future<void> _sendCertificateNotification(CertificateModel certificate) async {
    try {
      ...
      LoggerService.error('Failed to send certificate notification', error: error);
    }
  }
