...
class _AdminSetupPageState extends ConsumerState<AdminSetupPage> {
      ...
      if (mounted) {
        setState(() {
          if (status['activeAdmins'] > 0) {
            _statusMessage = 'System already has ${status['activeAdmins']} active admin(s)';
            _statusColor = AppTheme.successColor;
          } else {
            _statusMessage = 'No active admin found. System initialization required.';
  ...
  Future<void> _createInitialAdmin() async {
    ...
    try {
      ...
      LoggerService.error('Failed to create initial admin', error: e, stackTrace: stackTrace);
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            helperText: 'Minimum 8 characters, include uppercase, lowercase, numbers',
                          ),
